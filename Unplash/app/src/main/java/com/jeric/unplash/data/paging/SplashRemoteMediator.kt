package com.jeric.unplash.data.paging
...
class SplashRemoteMediator(
    private val apiService: UnSplashServiceApi,
    ...
    override suspend fun load(
        ...
        try {
            ...
            val response = apiService.getEditorialFeedImages(page = currentPage, perPage = ITEMS_PER_PAGE)

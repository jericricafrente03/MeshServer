                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @include('general/body/hospitality/facilityCategories/modals/edit/partials/details')
                            </div>
  ...
  <script>
    function uValidateForm(reform = false)
    {
        ...
        if(flag) {
            ...
            let uploadPreviewFile = $(modal+ ' #img_preview_uri').get(0).files[0];
            if (uploadFile) {
            ...
            inFooterScriptAjaxFileCreateUpdateSubmit(formData, reform, modal, "/facility-categories/edit", "POST");
        }

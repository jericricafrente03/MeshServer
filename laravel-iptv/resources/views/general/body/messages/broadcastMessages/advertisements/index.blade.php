...
<div class="page-wrapper">
    ...
    @include('general/body/messages/broadcastMessages/advertisements/modals/add/form')
    @include('general/body/messages/broadcastMessages/advertisements/modals/view/form')
    @include('general/body/messages/broadcastMessages/advertisements/modals/delete/form')
...
<script>
    ...
    $(document).ready(function() {  
        ...
        inFooterScriptAjaxDataTable({
            ...
            buttons: [
                ...
                @endcan
                @can('advertisements.delete_selected')
    ...
    function deleteSelected(){
        ...
        inFooterScriptSweetAlertDialogConfirmation(
            ...
            function () {                   // Callback function
                ...
                inFooterScriptAjaxCreateUpdateNoModalSubmit(data, false, "/advertisements/delete", 'DELETE');
    ...
    {   
        ...
        inFooterScriptSweetAlertDialogConfirmation(
            "Are you sure?",                // Custom title
            "Do you want to resend this advertisement?", // Custom text
            "Yes, resend it!",              // Custom confirm button text
            function () {                   // Callback function
                // This will run only when the user confirms
                inFooterScriptAjaxBasicGet(resultContainer, "/advertisements/resend", data);
            }
        );
    }

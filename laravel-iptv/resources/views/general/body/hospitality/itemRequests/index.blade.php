...
<div class="page-wrapper">
    ...
    @include('general/body/hospitality/itemRequests/modals/add/form')
    @include('general/body/hospitality/itemRequests/modals/edit/form')
    @include('general/body/hospitality/itemRequests/modals/view/form')
    @include('general/body/hospitality/itemRequests/modals/delete/form')
...
<script>
    ...
    {   
        ...
        inFooterScriptAjaxBasicGet(resultContainer, "/item-requests/toggle-enable", data);
    }

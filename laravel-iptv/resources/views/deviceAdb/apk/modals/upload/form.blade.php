<div class="modal" id="upload_modal" tabindex="-1">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @include('deviceAdb/apk/modals/upload/partials/details')
                            </div>
                            <!-- details info end -->
  ...
  <script>
    function validateForm(reform = false)
    {
        ...
        $('#upload_modal input, #upload_modal textarea, #upload_modal select').each(function() {
        ...
        if(flag) {
            ...
            let uploadFile = $(modal+' #uri').get(0).files[0];
            if (uploadFile) {
                formData.append("uri", uploadFile);
            }
            ...
            inFooterScriptAjaxFileCreateUpdateSubmit(formData, reform, modal, "/adb-apk/add", "POST", validatorForSelect2);
        }
    }
    ...
    function validatorForSelect2(response, modal){
        ...
        $.each(response, function (key, val) {
            switch (key) {
                case 'uri':
                    $(modal + " #" + 'uriValidation').after('<span class="error_txt" style="color:red; text-indent:15px;">' + val[0] + '</span>');

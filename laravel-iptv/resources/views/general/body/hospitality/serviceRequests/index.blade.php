...
<div class="page-wrapper">
    ...
    @include('general/body/hospitality/serviceRequests/modals/add/form')
    @include('general/body/hospitality/serviceRequests/modals/edit/form')
    @include('general/body/hospitality/serviceRequests/modals/view/form')
    @include('general/body/hospitality/serviceRequests/modals/delete/form')
...
<script>
    ...
    {   
        ...
        inFooterScriptAjaxBasicGet(resultContainer, "/service-requests/toggle-enable", data);
    }

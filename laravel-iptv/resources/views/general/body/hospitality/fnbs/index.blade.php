...
<div class="page-wrapper">
    ...
    @include('general/body/hospitality/fnbs/modals/add/form')
    @include('general/body/hospitality/fnbs/modals/edit/form')
    @include('general/body/hospitality/fnbs/modals/view/form')
    @include('general/body/hospitality/fnbs/modals/delete/form')
...
<script>
    ...
    $(document).ready(function() {     
        ...
        inFooterScriptAjaxDataTable({
            ...
            columns: [
                ...
                { data: 'unit_price', name: 'unit_price', title: 'Price', width: '1%', class: 'text-end',
    ...
    function showAddModal(){
        ...
        inFooterScriptAjaxBasicGet(loadCategoryDropdownResult, "/search/fnb-categories", categoryData);
    ...
    {   
        ...
        inFooterScriptAjaxBasicGet(resultContainer, "/fnb/toggle-enable", data);
    }
    ...
    function showEditModal(id, data){
        ...
        $(modal+' #unit_price').val(arr.unit_price);
        if(arr.category){
            let data = {
                id: arr.category_id,
                modal: modal
            };
            inFooterScriptAjaxBasicGet(loadCategoryDropdownResult, "/search/fnb-categories", data);  
        }
        else{
            let data = {
                id: '',

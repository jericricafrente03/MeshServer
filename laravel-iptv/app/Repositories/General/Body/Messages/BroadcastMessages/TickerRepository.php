...
class TickerRepository extends Controller implements ITickerRepository
{
    ...
    public function getData($request)
    {
        ...
        $query = BroadcastMessage::with('type', 'device_group')->where('broadcast_type_id', 46);
        ...
        foreach ($data as $value) {
            ...
            if(auth()->user()->canany(['tickers.view','tickers.resend', 'tickers.delete'])) {
                ...
                if(auth()->user()->can('tickers.resend')) {

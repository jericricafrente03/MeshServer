...
<div class="page-wrapper">
    ...
    @include('deviceAdb/files/screenRecord/modals/delete/form')
...
<script>
    ...
    $(document).ready(function() {    
        inFooterScriptAjaxDataTable({
            ...
            columns: [
                ...
                { data: 'img_uri', name: 'img_uri', title: 'Image', orderable: false, searchable: false, width: '15%'},
    ...
    function checkForUpdates() {
        $.ajax({
            url: '/adb-screen-record/check-table-changes',
            type: 'GET',

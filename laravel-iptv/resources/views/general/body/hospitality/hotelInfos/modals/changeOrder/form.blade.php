    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-header py-1">
          <h5 class="modal-title">Hotel Info Change Order</h5>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @include('general/body/hospitality/hotelInfos/modals/changeOrder/partials/details')
                            </div>
  ...
  <script>
    function cValidateForm(reform = false)
    {
        ...
        if(flag) {
            ...
            console.log(data);
            inFooterScriptAjaxCreateUpdateSubmit(data, reform, modal, "/hotel-infos/order", "PUT");
        }
    }

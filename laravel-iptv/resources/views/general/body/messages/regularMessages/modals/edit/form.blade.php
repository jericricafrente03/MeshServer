                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @include('general/body/messages/regularMessages/modals/edit/partials/details')
                            </div>
  ...
  <script>
    function uValidateForm(reform = false)
    {
        ...
        if(flag) {
            ...
            inFooterScriptAjaxCreateUpdateSubmit(data, reform, modal, "/regular-messages/edit", "PUT", validatorForSelect2);
        }

                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @include('general/body/hospitality/serviceRequests/modals/add/partials/details')
                            </div>
                            <!-- details info end -->
  ...
  <script>
    function validateForm(reform = false)
    {
        ...
        if(flag) {
            ...
            inFooterScriptAjaxFileCreateUpdateSubmit(formData, reform, modal, "/service-requests/add", "POST");
        }
    }

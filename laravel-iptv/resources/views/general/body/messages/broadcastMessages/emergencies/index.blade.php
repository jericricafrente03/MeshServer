...
<div class="page-wrapper">
    ...
    @include('general/body/messages/broadcastMessages/emergencies/modals/add/form')
    @include('general/body/messages/broadcastMessages/emergencies/modals/view/form')
    @include('general/body/messages/broadcastMessages/emergencies/modals/delete/form')
...
<script>
    ...
    function deleteSelected(){
        ...
        inFooterScriptSweetAlertDialogConfirmation(
            ...
            "Do you want to delete this emergency?", // Custom text
            "Yes, delete it!",              // Custom confirm button text
            function () {                   // Callback function
                // This will run only when the user confirms
                inFooterScriptAjaxCreateUpdateNoModalSubmit(data, false, "/emergencies/delete", 'DELETE');
    ...
    {   
        ...
        inFooterScriptSweetAlertDialogConfirmation(
            "Are you sure?",                // Custom title
            "Do you want to resend this emergency?", // Custom text
            "Yes, resend it!",              // Custom confirm button text
            function () {                   // Callback function
                // This will run only when the user confirms
                inFooterScriptAjaxBasicGet(resultContainer, "/emergencies/resend", data);
            }
        );
    }

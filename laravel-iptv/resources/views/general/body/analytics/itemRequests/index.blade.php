...
<div class="page-wrapper">
	<div class="page-content">
        ...
        <!-- first row -->
        @include('general/body/analytics/itemRequests/partials/firstRow')
        <!-- end of first row -->
        
        <!-- second row -->
        @include('general/body/analytics/itemRequests/partials/secondRow')
        <!-- end of second row -->

        <!-- third row -->
        @include('general/body/analytics/itemRequests/partials/thirdRow')
        <!-- end of third row -->
		
		<!-- fourth row -->
		@include('general/body/analytics/itemRequests/partials/fourthRow')
        <!-- end of fourth row -->
...
<script>
    ...
    $(document).ready(function() {
		inFooterScriptAjaxBasicGet(loadAnalyticData, "/analytics/get-item-request-data");
		...
		inFooterScriptAjaxBasicGet(loadItemDropdownResult, "/search/item-requests", data);
    });
	...
	$(document).on('change', '#item_id', function() {
        ...
        inFooterScriptAjaxBasicGet(loadItemCounterData, "/analytics/get-item-request-counter", data);
    });
	...
	function loadItemCounterData(result, data){
		...
		globalMonthBarChart = inFooterScriptBarChart(
			...
			[{ 
				colors: ['#15a0a3'],
				titleText: 'Monthly Item Request',
				titleAlign: 'left',
		...
		globalDayAreaChart = inFooterScriptAreaChart(
			...
			[{ 
				colors: ['#15a0a3'],
				titleText: '30 Days Item Request',
				titleAlign: 'left',
				subtitleText: 'Counter',
				subtitleAlign: 'left',
				chartForeColor: '#212529',

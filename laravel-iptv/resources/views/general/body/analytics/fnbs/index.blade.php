...
<div class="page-wrapper">
	<div class="page-content">
        ...
        <!-- first row -->
        @include('general/body/analytics/fnbs/partials/firstRow')
        <!-- end of first row -->
        
        <!-- second row -->
        @include('general/body/analytics/fnbs/partials/secondRow')
        <!-- end of second row -->

        <!-- third row -->
        @include('general/body/analytics/fnbs/partials/thirdRow')
        <!-- end of third row -->
		
		<!-- fourth row -->
		@include('general/body/analytics/fnbs/partials/fourthRow')
        <!-- end of fourth row -->

		<!-- fifth row -->
		@include('general/body/analytics/fnbs/partials/fifthRow')
		<!-- end of fifth row -->
...
<script>
    ...
    $(document).ready(function() {
		inFooterScriptAjaxBasicGet(loadAnalyticData, "/analytics/get-fnb-data");
		...
		inFooterScriptAjaxBasicGet(loadItemDropdownResult, "/search/fnbs", data);
    });
	...
	$(document).on('change', '#item_id', function() {
        ...
        inFooterScriptAjaxBasicGet(loadItemCounterData, "/analytics/get-fnb-counter", data);
    });
	...
	function loadAnalyticData(data){
		...
		globalCategoryDonutChart = inFooterScriptDonutChart(
            data.category_counter.total_counter,
            '#categoryDonutChart',
            [{ 
                colors: data.category_counter.color,
				chartForeColor: '#212529',
                chartHeight: 300,
				chartToolbarShow: true,
				legendPosition: 'top',
            ...
            globalCategoryDonutChart
        );

		let itemCategoryCounts = data.category_counter.data;

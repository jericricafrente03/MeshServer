                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @include('general/body/hospitality/facilities/modals/edit/partials/details')
                            </div>
  ...
  <script>
    function uValidateForm(reform = false)
    {
        ...
        if(flag) {
            ...
            inFooterScriptAjaxFileCreateUpdateSubmit(formData, reform, modal, "/facilities/edit", "POST", validatorForSelect2);
        }

<div class="modal" id="theme_zones_modal" tabindex="-1">
    <div class="modal-dialog modal-fullscreen">
      <div class="modal-content">

        <div class="modal-header py-1">
          <h5 class="modal-title">Theme Zones</h5>
        ...
        <div class="modal-body">
            ...
            <div class="card">
                <div class="card-header dt-card-header-themezones">
                    <select name='length_change' id='length_change_themezones' class="table_length_change form-select">
                    </select>
                    <input type="text" id="search_input_themezones" class="table_search_input form-control" placeholder="Search...">

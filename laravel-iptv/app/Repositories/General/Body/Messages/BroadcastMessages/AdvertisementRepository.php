...
class AdvertisementRepository extends Controller implements IAdvertisementRepository
{
    use FileUploadTrait;
    ...
    public function __construct(IUserHistoryLogRepository $logHistoriesRepo)
    {
        ...
        $this->activityName = 'advertisement';
    }
    ...
    public function getData($request)
    {
        ...
        $query = BroadcastMessage::with('type', 'device_group')->where('broadcast_type_id', 47);
        ...
        foreach ($data as $value) {
            ...
            if(auth()->user()->canany(['advertisements.view','advertisements.resend', 'advertisements.delete'])) {
                ...
                if(auth()->user()->can('advertisements.resend')) {
                ...
                if(auth()->user()->can('advertisements.view')) {
                    $actions .= '<li><a class="dropdown-item" href="javascript:void(0)"  class="me-1"
    ...
    {   
        try {
            ...
            $customDirectory = 'upload/broadcast_message/advertisements';

<div class="card-body m-2">
    ...
    <div class="col-sm-12">
        <input type="text" name="channel" id="channel" class="form-control w-100" autocomplete="off">
    </div>
    ...
    <div class="col-sm-12">
        <input type="text" name="order_no" id="order_no" class="form-control w-100" placeholder="0.00" autocomplete="off">
    </div> 
    ...
    <div class="col-sm-12">
        <input type="text" name="channel_uri" id="channel_uri" class="form-control w-100" placeholder="TV URI" autocomplete="off">
    </div> 

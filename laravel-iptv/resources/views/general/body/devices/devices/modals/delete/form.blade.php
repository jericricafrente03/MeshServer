  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" id="ok_btn" onclick="DeleteForm()">DELETE</button>
      </div>
    </div>
  </div>
</div>
...
<script>
    ...
    function DeleteForm(reform=false) {
        var data = {};
        let modal = "#delete_modal";
        data.id = $('#delete_modal #id').val();
        
        inFooterScriptAjaxCreateUpdateSubmit(data, reform, modal, "/devices/delete", "DELETE");
    }

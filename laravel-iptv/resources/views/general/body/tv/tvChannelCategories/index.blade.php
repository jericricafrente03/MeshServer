...
<div class="page-wrapper">
    ...
    @include('general/body/tv/tvChannelCategories/modals/add/form')
    @include('general/body/tv/tvChannelCategories/modals/edit/form')
    @include('general/body/tv/tvChannelCategories/modals/view/form')
    @include('general/body/tv/tvChannelCategories/modals/delete/form')
    @include('general/body/tv/tvChannelCategories/modals/changeOrder/form')
...
<script>
    ...
    $(document).ready(function() {     
        ...
        inFooterScriptAjaxDataTable({
            ...
            order: [[0, 'desc']],
            buttons: [
                @can('tv_channel_categories.create')
            ...
            pageLength: 10,
            searching: true,
            url: '/tv-channel-categories/data',  
            type: 'GET',
            data: function(data) {

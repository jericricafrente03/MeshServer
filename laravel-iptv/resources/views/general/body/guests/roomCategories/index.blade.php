...
<div class="page-wrapper">
    ...
    @include('general/body/guests/roomCategories/modals/add/form')
    @include('general/body/guests/roomCategories/modals/edit/form')
    @include('general/body/guests/roomCategories/modals/view/form')
    @include('general/body/guests/roomCategories/modals/delete/form')
    @include('general/body/guests/roomCategories/modals/changeOrder/form')
        ...
        inFooterScriptAjaxDataTable({
            ...
            buttons: [
                @can('room_categories.create')
                    { text: 'Add Room Category', className: 'btn btn-primary', action: function ( e, dt, node, config ) {
                        showAddModal();
                    }},
                @endcan
            ],

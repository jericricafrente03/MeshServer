...
<div class="page-wrapper">
    ...
    @include('general/body/hospitality/fnbCategories/modals/add/form')
    @include('general/body/hospitality/fnbCategories/modals/edit/form')
    @include('general/body/hospitality/fnbCategories/modals/view/form')
    @include('general/body/hospitality/fnbCategories/modals/delete/form')
    @include('general/body/hospitality/fnbCategories/modals/changeOrder/form')

...
<div class="page-wrapper">
    ...
    @include('general/body/tv/tvChannels/modals/add/form')
    @include('general/body/tv/tvChannels/modals/edit/form')
    @include('general/body/tv/tvChannels/modals/view/form')
    @include('general/body/tv/tvChannels/modals/delete/form')
    @include('general/body/tv/tvChannels/modals/changeOrder/form')
...
<script>
    ...
    function showAddModal(){
        ...
        inFooterScriptAjaxBasicGet(loadCategoryDropdownResult, "/search/tv-channel-categories", categoryData);
    ...
    {   
        ...
        inFooterScriptAjaxBasicGet(resultContainer, "/tv-channels/toggle-enable", data);
    }
    ...
    function showEditModal(id, data){
        ...
        $(modal+' #order_no').val(arr.order_no);
        $(modal+' #channel_uri').val(arr.channel_uri);
        $(modal+' #channel').val(arr.channel);
        if(arr.category){
            let data = {
                id: arr.category_id,
                modal: modal
            };
            inFooterScriptAjaxBasicGet(loadCategoryDropdownResult, "/search/tv-channel-categories", data);  
        }
        else{
            let data = {
                id: '',
    ...
    function showViewModal(id, data){
        ...
        $(modal+' #channel_uri').text(arr.channel_uri);
        $(modal+' #channel').text(arr.channel);
        if(arr.img_uri){

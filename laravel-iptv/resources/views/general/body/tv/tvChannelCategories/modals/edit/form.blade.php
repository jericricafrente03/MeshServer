    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-header py-1">
          <h5 class="modal-title">Edit FnB Category</h5>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @include('general/body/tv/tvChannelCategories/modals/edit/partials/details')
                            </div>
  ...
  <script>
    function uValidateForm(reform = false)
    {
        ...
        if(flag) {
            ...
            inFooterScriptAjaxCreateUpdateSubmit(data, reform, modal, "/tv-channel-categories/edit", "PUT");
        }
